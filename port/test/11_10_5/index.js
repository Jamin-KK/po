...
.to(openTriggerTop, 0.4, {
  x: "+8vw", y: "-8vw", delay: 0.1, ease: Power4.easeIn, onComplete: function() {
    closeTrigger.css('z-index','25');
  }
}, "preOpen")
.to(openTriggerMiddle, 0.4, {
  x: "+=8vw", y: "-=8vw", ease: Power4.easeIn,
  onComplete: function() {
    openTrigger.css('visibility','hidden');
  }
}, "preOpen")
.to(openTriggerBottom, 0.4, {
  x: "+=8vw", y: "-=8vw", delay: 0.2, ease: Power4.easeIn
}, "preOpen")
.add("open", "-=0.4")
.to(menuTop, 0.8, {
  y: "13%",
...
.to(closeTriggerLeft, 0.8, {
  x: "-=10vw", y: "+=10vw", ease: Power4.easeOut
}, "preClose")
.to(closeTriggerRight, 0.8, {
  x: "+=10vw", y: "+=10vw", delay: 0.2, ease: Power4.easeOut
}, "preClose");
...
.to(closeTriggerLeft, 0.2, {
  x: "+=10vw", y: "-=10vw", ease: Power4.easeIn
}, "close")
.to(closeTriggerRight, 0.2, {
  x: "-=10vw", y: "-=10vw", delay: 0.1, ease: Power4.easeIn
}, "close")
.to(openTriggerTop, 1, {
  x: "-=8vw", y: "+=8vw", delay: 0.2, ease: Power4.easeOut
}, "close")
.to(openTriggerMiddle, 1, {
  x: "-=8vw", y: "+=8vw", ease: Power4.easeOut
}, "close")
.to(openTriggerBottom, 1, {
  x: "-=8vw", y: "+=8vw", delay: 0.1, ease: Power4.easeOut
}, "close");
